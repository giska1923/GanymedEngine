...
| [ONLINE.md](ONLINE.md)                             | **Milestone plan** — the engine side of the (separate-repo, Go) backend: IXWebSocket transport, non-blocking request layer with owner-scoped callbacks, device identity, leaderboard + push bindings, dedicated-server hooks                    | O0–O5, none started; O5 blocked   |
