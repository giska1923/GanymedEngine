...
| [SKELETAL_ATTACHMENTS.md](SKELETAL_ATTACHMENTS.md) | **Milestone plan** — attaching entities to joints, so a character can hold something                                                                                                                                                    | A1–A3 landed; visual A3 + hide-unresolved deferred |
| [SKELETAL_TOOLING.md](SKELETAL_TOOLING.md)         | **Milestone plan** — seeing and selecting joints: a skeleton visualizer, joint picking, a socket gizmo, and a clip inspector that measures the artifacts every download has had                                                         | S1–S3 done; S4–S6 planned         |
