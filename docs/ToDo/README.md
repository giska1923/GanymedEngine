...
| [editor-visual-parity.md](editor-visual-parity.md) | Editor look-and-feel milestone: theme tokens, fonts/icons, panel furniture, status bar, custom window chrome | 4 phases remaining (0–5 done) |
