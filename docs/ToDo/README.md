...
| [TWO_HAND_IK.md](TWO_HAND_IK.md)                   | **Milestone plan** — two-hand weapon IK: the rifle posed from the chest and the aim, both arms solved onto `Grip`/`Support` markers on the weapon, aim lock | H1–H6 planned                     |
