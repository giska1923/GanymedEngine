...
| [AIM_OFFSET.md](AIM_OFFSET.md)                     | **Milestone plan** — procedural aim offset: `AimOffsetComponent`, a pitch/yaw pass over a named spine chain after sampling, inspector preview, Proving Ground wiring, viewport aim handle | A1–A5 planned                     |
