...
| [SKELETAL_TOOLING.md](SKELETAL_TOOLING.md)         | **Milestone plan** — seeing and selecting joints: a skeleton visualizer, joint picking, a socket gizmo, and a clip inspector that measures the artifacts every download has had                                                         | S1 done; S2–S6 planned            |
