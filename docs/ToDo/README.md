...
| [editor-visual-parity.md](editor-visual-parity.md) | Editor look-and-feel milestone: theme tokens, fonts/icons, panel furniture, status bar, custom window chrome | 5 phases remaining (0–4 done) |
