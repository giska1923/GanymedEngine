...
| [MODEL_EDITOR.md](MODEL_EDITOR.md)                 | **Milestone plan** — an inspector for assets rather than entities: readouts, import settings written to `.meta`, a collision default, a preview renderer, thumbnails                                                                    | P1–P4 done; P5–P7 remain |
