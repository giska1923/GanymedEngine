...
- [`PARTICLE_ROADMAP.md`](toDo&done/PARTICLE_ROADMAP.md) — the particle system milestone (CPU-simulated emitters, billboard + instanced-mesh rendering, keyframed curves with an in-house curve editor; **phases 1–4 complete** — curve/RNG, deterministic CPU sim, billboard + mesh draws, curve editor + inspector preview; phase 5 planned)
