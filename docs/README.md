...
- [`PARTICLE_ROADMAP.md`](toDo&done/PARTICLE_ROADMAP.md) — the particle system milestone (CPU-simulated emitters, billboard + instanced-mesh rendering, keyframed curves with an in-house curve editor; **phase 1 complete** — curve + RNG foundations; phases 2–5 planned)
