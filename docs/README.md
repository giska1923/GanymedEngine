...
- [`editor-visual-parity.md`](history/editor-visual-parity.md) — Cold War editor look: token layer, Inter/Lucide, panel furniture, status bar, custom title bar (**complete** — phases 0–9; see [editor.md](editor/editor.md) and [platform.md](engine/platform.md#custom-title-bar))
