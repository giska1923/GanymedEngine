...
- [`Scripting-And-UI-Integration.md`](toDo&done/Scripting-And-UI-Integration.md) — the current phase (revised 2026-07-19 for the post-bgfx/post-ECS engine; milestones 1–2 landed, see [scripting.md](engine/scripting.md))
